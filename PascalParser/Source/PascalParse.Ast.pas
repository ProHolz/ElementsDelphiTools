...
public
    ...
    method RunWithString(const Context: not nullable String; const aCompiler : DelphiCompiler = DelphiCompiler.dcDefault): TSyntaxNode; reintroduce; overload; virtual;


    class method RunWithString(const Context: not nullable String; InterfaceOnly: Boolean = False;  const aCompiler : DelphiCompiler = DelphiCompiler.dcDefault;
...
method TPasSyntaxTreeBuilder.BuildExpressionTree(
