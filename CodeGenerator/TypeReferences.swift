...
public class CGRangeTypeReference : CGTypeReference {
	public let Start: CGExpression
	public let End: CGExpression

	public init(_ start: CGExpression, _ end: CGExpression) {
		Start = start
		End = end
	}

	override func copyWithNullability(_ nullability: CGTypeNullabilityKind) -> CGTypeReference {
		let result = CGRangeTypeReference(Start, End)
		result.Nullability = nullability
		return result
	}
}
