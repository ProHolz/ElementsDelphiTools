...
var lppa = CGPointerDereferenceExpression(lpa)
var lpn2 = CGPropertyAccessExpression(lppa, "Next")
var lpn3 = CGPropertyAccessExpression(lpn2, "Result")

var lpn4 = CGPointerDereferenceExpression(lpn3)


td.Statements.Add(lpn4)
